...
//     try {
//       if (restaurant) {
//         await axios.put(`http://192.168.18.15:3000/api/restaurants/${restaurant._id}`, form, {
//           headers: { 'Content-Type': 'multipart/form-data' },
//         });
//       } else {
//         await axios.post('http://192.168.18.15:3000/api/restaurants', form, {
//           headers: { 'Content-Type': 'multipart/form-data' },
//         });
//       }
...
//       fetchRestaurants();
//       if (onClose) onClose();
//       Alert.alert('Success', restaurant ? 'Restaurant updated successfully' : 'Restaurant added successfully');
//     } catch (error) {
